...
var User = {
    ...
    getLoginParams : function(email, callback){
        return connection.query("SELECT code_cpf, name, surname, birthdate, sex, email, password, create_time, cellphone, phone_number, image, id_address_fk FROM User WHERE Email = ?", [email], callback);
    }/*,
